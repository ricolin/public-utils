...
git clone https://opendev.org/openstack/devstack --branch stable/2024.2 /opt/stack/devstack
...
enable_plugin neutron https://opendev.org/openstack/neutron stable/2024.2
